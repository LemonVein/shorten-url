...
public class UrlApiController {
    ...
    public String makeShortenUrl(@RequestParam String originalUrl, HttpServletRequest request){
        String shortenUrl = urlService.createShortenUrl(originalUrl, request);

        return shortenUrl;
    }

    @GetMapping("/my-urls")
    public ResponseEntity<?> getUserUrls(HttpServletRequest request) throws JsonProcessingException {
        ...
        List<Url> urls = urlService.getUrls(request);
